...
void simulation_placement() {
	...
	printf("%lf\n", total_serviced_bandwidth_in_placement);
...
void simulation_migartion() {
	...
	for (int day = 1; day <= NUM_OF_DATEs; day++) {
		...
		if (day == 1 || day == 3 || day == 7 || day == 15 || day == 30) {
			...
			if (day == 3) {
				result1.push_back(total_serviced_bandwidth_in_migration);
				result2.push_back((sum_for_AVG_in_migration / num_of_SSDs));
				result3.push_back(sqrt(sum_for_STD_in_migration / num_of_SSDs));
			}
			if (day == 1) {
				result1_day1.push_back(total_serviced_bandwidth_in_migration);
			...
			if (day == 7) {
				result1_day7.push_back(total_serviced_bandwidth_in_migration);
			...
			if (day == 15) {
				result1_day15.push_back(total_serviced_bandwidth_in_migration);
			...
			if (day == 30) {
				result1_day30.push_back(total_serviced_bandwidth_in_migration);
