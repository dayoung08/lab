...
void CA_phase(server* _server_list, channel* _channel_list, bitrate_version_set* _version_set, int cost_limit, short* _selected_set, short** _selected_ES, double* _used_GHz, short* _ES_count, bool _flag);
